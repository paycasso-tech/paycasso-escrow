...
const cards = [
  {
    ...
    title: "Our Vision",
    alt: "Vision Icon",
    content: "Our vision is to revolutionize global work payments with secure, low-cost, and transparent smart contract-based escrow and instant USDC settlements",
  },
  {
    image: "/advantages.svg",
    title: "Bypass local currency instability",
    alt: "Advantages Icon",
    content: "Pay and get paid in stablecoins USDC which are pegged 1:1 with US dollars",
  },
  {
    image: "/how-it-works.svg",
    title: "Dual sided protection",
    alt: "How it Works Icon",
    content: "Fairness guaranteed for both sides. Funds locked in smart contract escrow until contract conditions are met",
  },
  {
    image: "/about-rocket.svg",
    title: "Put Your Idle Crypto to Work",
    alt: "Lorem Ipsum Icon",
    content: "Convert Bitcoin, Ethereum, and other tokens to USDC and pay freelancers and gig workers instantly",
  },
];
...
export default function AboutSection() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setLeftAnim(Math.sin(leftPos * 0.02) * 24 + Math.cos(leftPos * 0.015) * 12);
      setRightAnim(Math.sin(rightPos * 0.02) * 24 + Math.cos(rightPos * 0.015) * 12);
    ...
    >
      ...
      <style jsx>{`
        ...
        @keyframes floatParticle4 {
          0%, 100% { transform: translateY(0px) translateX(0px); }
          50% { transform: translateY(-22px) translateX(7px); }
        }
